...
if (!formData.email.trim()) {
      ...
      newErrors.email = 'Only lowercase Gmail addresses (e.g. example@gmail.com) are allowed';
    }
...
<div className="password-wrapper">
            <input type={showConfirmPassword ? 'text' : 'password'}placeholder="Confirm Password"name="confirmPassword"value={formData.confirmPassword}onChange={handleInputChange}/>
