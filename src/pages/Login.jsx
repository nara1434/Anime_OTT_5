...
const Login = () => {
  ...
  const handleLogin = () => {
    if (validateForm()) {
      // Use navigate instead of window.location.href for navigation
      navigate('/romanticThemeHome'); 
    }
  };
  ...
  return (
    <div className="login-body">
      ...
      <div className="login-right">
        <button className="login-toggle" onClick={() => navigate('/signup')}>Signup</button>
        <div className="login-container">
          <h2>Login to Your Account</h2>
